...
def jwt_payload(user, context=None):
    ...
    payload['https://hasura.io/jwt/claims']['x-hasura-allowed-roles'] = [user.profile.role.name]
    payload['https://hasura.io/jwt/claims']['x-hasura-default-role'] = user.profile.role.name
